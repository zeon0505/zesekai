<div x-data="animeHelper()">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h3 class="text-2xl font-black text-white uppercase tracking-tighter">Add New Anime</h3>
            <p class="text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-1">Create a new entry in the records</p>
        </div>
