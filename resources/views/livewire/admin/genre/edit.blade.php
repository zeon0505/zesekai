<div>
    <div class="flex justify-between items-center mb-6">
        <div>
            <h3 class="text-2xl font-black text-white uppercase tracking-tighter">Edit Genre</h3>
            <p class="text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-1">Update genre details</p>
        </div>
