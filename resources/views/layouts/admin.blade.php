        ...
        <div id="sidebar" class="sidebar-wrapper">
            ...
            <div class="sidebar-menu">
                <ul class="list-none p-0 m-0">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('admin.anime.*') ? 'active' : '' }}">
                        <a href="{{ route('admin.anime.index') }}" class='sidebar-link'>
                    ...
                    <li class="sidebar-item {{ request()->routeIs('admin.genres.*') ? 'active' : '' }}">
                        <a href="{{ route('admin.genres.index') }}" class='sidebar-link'>
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('home') }}" class='sidebar-link hover:!text-white group'>
                            <i class="bi bi-box-arrow-up-right group-hover:!text-white"></i>
                            <span>View Website</span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ request()->routeIs('admin.settings.hero') ? 'active' : '' }}">
                        <a href="{{ route('admin.settings.hero') }}" class='sidebar-link'>
                            <i class="bi bi-layout-text-window-reverse"></i>
                            <span>Hero Section</span>
                        </a>
                    </li>
                    
                    <!-- General Settings Link (Placeholder/To be implemented if separate page needed, or just part of settings) -->
                     <li class="sidebar-item {{ request()->routeIs('admin.settings.general') ? 'active' : '' }}">
                        <a href="{{ route('admin.settings.general') }}" class='sidebar-link'>
        ...
        <div id="main" class="main-content">
            <header class="mb-10 flex justify-between items-center">
                ...
                <div class="hidden xl:block">
                     ...
                     <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mt-1">Manage your anime platform</p>
                </div>
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('profile') }}" class="text-right hidden sm:block group">
                        ...
                        <div class="text-[10px] text-red-500 font-bold uppercase tracking-widest">Administrator</div>
                    </a>
